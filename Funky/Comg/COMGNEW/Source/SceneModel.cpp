...
void SceneModel::Init()
{
	...
	m_parameters[U_LIGHT0_COSCUTOFF] = glGetUniformLocation(m_programID, "lights[0].cosC	utoff");
	...
	camera.Init(Vector3(0, 40, 30), Vector3(0, 30, 0), Vector3(0, 1, 0));
	...
	meshList[GEO_QUAD] = MeshBuilder::GenerateQuad("floor", Color(0.f, 1.f, 0.f));
	...
	meshList[GEO_XWING] = MeshBuilder::GenerateOBJ("model1", "OBJ//XWING.obj");
	meshList[GEO_XWING]->textureID = LoadTGA("Image//150576E_XWING_Texture.tga");
	meshList[GEO_ATST] = MeshBuilder::GenerateOBJ("model1", "OBJ//ATST.obj");
	meshList[GEO_ATST]->textureID = LoadTGA("Image//150576E_ATST_Texture.tga");
}
...
void SceneModel::Render()
{
	...
	modelStack.PushMatrix();
	modelStack.Translate(0.f, 0.f, -3.f);
