...
Mesh* MeshBuilder::GenerateSphere(const std::string &meshName, Color color, float numStacks, unsigned numSlices)
{
	std::vector<Vertex> vertex_buffer_data;
	std::vector<GLuint> index_buffer_data;
	Vertex v;
...
Mesh* MeshBuilder::GenerateMoustache(const std::string &meshName, Color color)
{
	std::vector<Vertex> vertex_buffer_data;
	std::vector<GLuint> index_buffer_data;
	Vertex v;
	...
	//top
	v.pos.Set(2.f, 1.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(4.f, 0.5f, 0.5f);	    v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(2.5f, 2.f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(2.f, 1.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(4.f, 0.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(3.5f, 0.f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);

	v.pos.Set(2.f, 1.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(2.5f, 0.f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(3.f, 0.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(2.f, 1.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(1.f, 1.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(2.5f, 0.f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);

	v.pos.Set(2.f, 1.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(1.5f, 2.f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(1.f, 1.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);

	v.pos.Set(2.f, 1.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(2.f, 0.5f, 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);	vertex_buffer_data.push_back(v);
...
Mesh* MeshBuilder::GenerateMoustache2(const std::string &meshName, Color color)
{
	std::vector<Vertex> vertex_buffer_data;
	std::vector<GLuint> index_buffer_data;
	Vertex v;
...
Mesh* MeshBuilder::GenerateMoustache3(const std::string &meshName, Color color)
{
	std::vector<Vertex> vertex_buffer_data;
	std::vector<GLuint> index_buffer_data;
	Vertex v;
...
Mesh* MeshBuilder::GenerateMoustache4(const std::string &meshName, Color color)
{
	std::vector<Vertex> vertex_buffer_data;
	std::vector<GLuint> index_buffer_data;
	Vertex v;
